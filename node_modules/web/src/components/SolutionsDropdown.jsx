...
const SolutionsDropdown = ({ isOpen, onMouseEnter, onMouseLeave }) => {
  const items = [
    { label: 'Plantas industriales completas', href: '#plantas-completas' },
    { label: 'Automatización industrial', href: '#automatizacion' },
    { label: 'Ingeniería de procesos', href: '#ingenieria' },
    { label: 'Integración de maquinaria', href: '#integracion' },
    { label: 'Equipos industriales', href: '#equipos' }
  ];
