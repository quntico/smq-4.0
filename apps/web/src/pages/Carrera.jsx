...
const Carrera = () => {
  ...
  const careersList = [
    {
      title: t('carrera.items.0.title'),
      desc: t('carrera.items.0.desc')
    },
    {
      title: t('carrera.items.1.title'),
      desc: t('carrera.items.1.desc')
    },
    {
      title: t('carrera.items.2.title'),
      desc: t('carrera.items.2.desc')
    }
  ];
  ...
  return (
    <>
      <Helmet>
        <title>{t('companyNav.items.carreraTitle')} | SMQ 4.0</title>
        <meta name="description" content={t('companyNav.items.carreraDesc')} />
      </Helmet>

      <div className="min-h-screen bg-[#030712] text-white flex flex-col font-sans select-none overflow-x-hidden">
        {/* HERO SECTION */}
        <section className="relative flex flex-col justify-center px-[40px] md:px-[80px] border-b border-white/5 bg-[#030712] overflow-hidden pt-40 pb-6 z-10">
          ...
          <div className="max-w-[1400px] w-full mx-auto relative z-10 flex items-stretch justify-start">
            ...
            <div className="pl-6 md:pl-10 flex flex-col items-start gap-4 py-2">
              ...
              <h1 className="text-4xl md:text-6xl lg:text-[75px] font-black tracking-tight leading-none uppercase font-sans">
                <DecipherText text={t('carrera.title')} delay={200} />
              </h1>
        ...
        <section className="py-8 px-[40px] md:px-[80px] relative border-b border-white/5 bg-[#030712] flex-1 flex flex-col justify-center">
          <div className="max-w-[1000px] w-full mx-auto text-center flex flex-col items-center gap-4">
            <span className="text-[11px] font-black uppercase tracking-[0.3em] text-[#EC4899]">{t('carrera.oppLabel')}</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full text-left mt-4">
              {careersList.map((item, idx) => (
                <div key={idx} className="border border-white/5 bg-[#0e131b]/30 p-4 rounded-xl hover:bg-[#0e131b]/50 transition-colors">
